...
/// Initialize Flow presets with built-in configurations
pub fn init_presets(preset_manager: &mut FlowPresetManager) {
    ...
    tracing::info!("Initialized {} Flow presets", preset_count);
}
