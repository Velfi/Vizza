  ...
  <div class="settings-section">
    ...
    <div class="setting-row">
      ...
      <Selector
        ...
        value={getBooleanString(settings.enable_fluid_dynamics !== undefined ? settings.enable_fluid_dynamics : true)}
        on:change={(e) => handleSettingChange('enable_fluid_dynamics', getBooleanValue(e.detail.value))}
      />
    </div>
  ...
  <div class="settings-section">
    ...
    <div class="setting-row">
      ...
      <Selector
        ...
        options={booleanOptions}
        value={getBooleanString(settings.enable_light_gradient !== undefined ? settings.enable_light_gradient : true)}
        on:change={(e) => handleSettingChange('enable_light_gradient', getBooleanValue(e.detail.value))}
      />
    </div>
  ...
  <div class="settings-section">
    ...
    <div class="setting-row">
      ...
      <Selector
        id="enable-biofilm"
        options={booleanOptions}
        value={getBooleanString(settings.enable_biofilm_formation !== undefined ? settings.enable_biofilm_formation : true)}
        on:change={(e) => handleSettingChange('enable_biofilm_formation', getBooleanValue(e.detail.value))}
      />
    </div>
  ...
  <div class="settings-section">
    ...
    <div class="setting-row">
      ...
      <Selector
        ...
        options={booleanOptions}
        value={getBooleanString(settings.show_chemical_fields !== undefined ? settings.show_chemical_fields : false)}
        on:change={(e) => handleSettingChange('show_chemical_fields', getBooleanValue(e.detail.value))}
      />
    </div>
      ...
      <div class="sub-section">
        <div class="setting-row">
          ...
          <Selector
            id="show-oxygen"
            options={booleanOptions}
            value={getBooleanString(settings.show_oxygen !== undefined ? settings.show_oxygen : false)}
        ...
        <div class="setting-row">
          ...
          <Selector
            id="show-nitrogen"
            options={booleanOptions}
            value={getBooleanString(settings.show_nitrogen !== undefined ? settings.show_nitrogen : false)}
        ...
        <div class="setting-row">
          ...
          <Selector
            id="show-pheromones"
            options={booleanOptions}
            value={getBooleanString(settings.show_pheromones !== undefined ? settings.show_pheromones : false)}
            on:change={(e) => handleSettingChange('show_pheromones', getBooleanValue(e.detail.value))}
          />
        </div>
        ...
        <div class="setting-row">
          ...
          <Selector
            id="show-toxins"
            options={booleanOptions}
            value={getBooleanString(settings.show_toxins !== undefined ? settings.show_toxins : false)}
        ...
        <div class="setting-row">
          ...
          <Selector
            id="show-attractants"
            options={booleanOptions}
            value={getBooleanString(settings.show_attractants !== undefined ? settings.show_attractants : false)}
            on:change={(e) => handleSettingChange('show_attractants', getBooleanValue(e.detail.value))}
          />
        </div>
    ...
    <div class="setting-row">
      ...
      <Selector
        ...
        options={booleanOptions}
        value={getBooleanString(settings.show_light_gradient !== undefined ? settings.show_light_gradient : false)}
        on:change={(e) => handleSettingChange('show_light_gradient', getBooleanValue(e.detail.value))}
      />
    </div>
    ...
    <div class="setting-row">
      ...
      <Selector
        ...
        options={booleanOptions}
        value={getBooleanString(settings.show_temperature_zones !== undefined ? settings.show_temperature_zones : false)}
        on:change={(e) => handleSettingChange('show_temperature_zones', getBooleanValue(e.detail.value))}
      />
    </div>
    ...
    <div class="setting-row">
      ...
      <Selector
        id="show-ph-zones"
        options={booleanOptions}
        value={getBooleanString(settings.show_ph_zones !== undefined ? settings.show_ph_zones : false)}
    ...
    <div class="setting-row">
      ...
      <Selector
        ...
        options={booleanOptions}
        value={getBooleanString(settings.show_energy_as_size !== undefined ? settings.show_energy_as_size : false)}
