<div class="menu-container">
    <div class="menu-header">
        ...
        <div class="menu-actions">
            <button
                ...
                on:click={() => selectSimulation('settings')}
                aria-label="Settings"
                title="Settings"
            >
                <svg
    ...
    <div class="simulation-grid">
        <button
            class="simulation-card how-to-play"
        ...
        <button class="simulation-card" on:click={() => selectSimulation('moire')}>
            <h2>Moiré</h2>
        ...
        <div class="about-container">
            ...
            <p>
                Hi. My name is Zelda and I'm the author of Vizza. Thanks for checking it out!. I
                made this for fun.
            </p>
            <p>
...
<style>
    ...
    .simulation-card.how-to-play {
        background: rgba(100, 108, 255, 0.15);
        border-color: rgba(100, 108, 255, 0.3);
        grid-column: span 2;
    }

    .simulation-card.how-to-play:hover {
